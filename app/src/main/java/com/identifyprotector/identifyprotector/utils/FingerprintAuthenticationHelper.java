    ...
    public void completeFingerprintAuthentication(Activity activity, TextView feedbackTextView) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (fingerprintManager != null && !fingerprintManager.isHardwareDetected()) {
                ...
                feedbackTextView.setText(R2.string.fingerprint_device_does_not_support);
            }
            ...
            if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.USE_FINGERPRINT) != PackageManager.PERMISSION_GRANTED) {
                ...
                feedbackTextView.setVisibility(View.VISIBLE);
                feedbackTextView.setText(R2.string.fingerprint_please_enable_permission);
            }
            ...
            if (fingerprintManager != null && !fingerprintManager.hasEnrolledFingerprints()) {
                ...
                feedbackTextView.setVisibility(View.VISIBLE);
                feedbackTextView.setText(R2.string.fingerprint_no_fingerprint_configured);
            }
            ...
            if (keyguardManager != null) {
                if (!keyguardManager.isKeyguardSecure()) {
                    ...
                    feedbackTextView.setVisibility(View.VISIBLE);
                    feedbackTextView.setText(R2.string.fingerprint_please_enable_lock_screen);
                } else {
                    try {
                        generateKey();
