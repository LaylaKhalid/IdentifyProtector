...
import com.identifyprotector.identifyprotector.model.AutofillDataset;
import com.identifyprotector.identifyprotector.model.DatasetWithFilledAutofillFields;
import com.identifyprotector.identifyprotector.model.FieldType;
import com.identifyprotector.identifyprotector.model.FieldTypeWithHeuristics;
import com.identifyprotector.identifyprotector.model.FilledAutofillField;
...
public class ManualActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R2.layout.multidataset_service_manual_activity);
        ...
        mRecyclerView = findViewById(R2.id.suggestionsList);
...
//                });
    ...
    private static class DatasetViewHolder extends RecyclerView.ViewHolder {
        ...
        public DatasetViewHolder(View itemView, Activity activity) {
            super(itemView);
            mRootView = itemView;
            mDatasetNameText = itemView.findViewById(R2.id.datasetName);
            mFieldTypesText = itemView.findViewById(R2.id.fieldTypes);
            mActivity = activity;
        }
        ...
        public static DatasetViewHolder newInstance(ViewGroup parent, Activity activity) {
            return new DatasetViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R2.layout.dataset_suggestion, parent, false), activity);
        }
