...
import static com.identifyprotector.identifyprotector.util.Util.EXTRA_DATASET_NAME;
import static com.identifyprotector.identifyprotector.util.Util.EXTRA_FOR_RESPONSE;
...
public class AuthActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R2.layout.multidataset_service_auth_activity);
        ...
        mMasterPassword = findViewById(R2.id.master_password);
        mPackageName = getPackageName();
        mPreferences = MyPreferences.getInstance(this);
        findViewById(R2.id.login).setOnClickListener((view) -> login());
        findViewById(R2.id.cancel).setOnClickListener((view) -> {
            onFailure();
    ...
    private void login() {
        ...
        if (password.toString().equals("112233")) {
            onSuccess();
        } else {
