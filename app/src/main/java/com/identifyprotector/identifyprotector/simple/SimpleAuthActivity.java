...
public class SimpleAuthActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R2.layout.simple_service_auth_activity);
        findViewById(R2.id.yes).setOnClickListener((view) -> onYes());
        findViewById(R2.id.no).setOnClickListener((view) -> onNo());
    }
